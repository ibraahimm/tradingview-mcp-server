...
Exit 0 = live JS and rules.yaml agree on TASI-W1/TASI-W2 params; non-zero = drift.
...
MIN_DOC_DEFAULTS = {"TASI-W1": 3, "TASI-W2": 8, "TASI-W3": 0}  # W2 6->8: p1m_max/py_min guardrails restored (D-2026-07-04-01)
...
def main() -> int:
    ...
    if fails:
        ...
        for f in fails:
            print("  -", f)
        return 1
    print("PASS: methodology parity — live JS (TASI-W1/TASI-W2) + command-doc Step-2 defaults (TASI-W1/TASI-W2/TASI-W3) == rules.yaml.")
    return 0
